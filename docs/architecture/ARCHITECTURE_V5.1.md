...
**Version**: v5.1
**Date**: 2025-11-12
**Status**: ✅ Core Components Complete + Address Migration Complete
...
- Main chain indexing (height-based + epoch-based)
...
Phase 1: Height Query (get remote height)
   ↓
Phase 2: Main Chain Sync (sync by height, batch of 512 blocks)
   ↓
...
3. Determine sync strategy
   ...
   ↓
4. Main Chain Sync (height-based)
   ├─► Request blocks by height (batch of 512)
...
**Version**: v5.1 (Core Components Complete + Address Migration Complete)
